...
import walletController from '../controller/admin/walletManage.js';
...
router.get('/dashboard/data', adminAuth.checkSession,dashboardController.getDashboardData);
router.get('/dashboard/products',adminAuth.checkSession, dashboardController.getBestSellingProducts);
router.get('/dashboard/categories',adminAuth.checkSession, dashboardController.getBestSellingCategories);
router.get('/dashboard/brands',adminAuth.checkSession, dashboardController.getBestSellingBrands);
router.get('/dashboard/orders', adminAuth.checkSession,dashboardController.getRecentOrders);


router.get('/wallet-management',adminAuth.checkSession, walletController.loadWalletManagement);
router.post('/wallet/add-money', adminAuth.checkSession,walletController.addMoneyToWallet);
router.post('/wallet/deduct-money',adminAuth.checkSession, walletController.deductMoneyFromWallet);
